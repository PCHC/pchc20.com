  ...
  return [
    {
      year: 1997,
      description: [
        'PCHC incorporated and Board of Directors formed',
      ],
      image: '1997.jpg',
    },
    {
      year: 1998,
      description: [
        'PCHC opens on Union St. in Bangor',
        'Founding Physician, Barbara Vereault, DO, is hired as the medical director.',
      ],
      image: '1998.jpg',
    },
    {
      year: 1999,
      description: [
        'FQHC Look-a-Like status awarded by the Health Resources and Services Administration',
      ],
      image: '1999.jpg',
    },
    {
      year: 2001,
      description: [
        'Moved to 1012 Union Street in Bangor with 20 exam rooms in 7,500 square feet',
      ],
      image: '2001.jpg',
    },
    {
      year: 2002,
      description: [
        'Pediatrics and Mental Health services begin',
        'Ken Schmidt hired as first CEO',
      ],
      image: '2002.jpg',
    },
    {
    ...
    },
    {
      year: 2008,
      description: [
        'Brewer Community Clinic opens',
        'PCHC earns Joint Commission accreditation',
      ],
      image: '2008.jpg',
      details: {
        text: [
    ...
    },
    {
      ...
      details: {
        text: [
          ...
          'Key Clinic opens',
          'Hope House and Eastern Maine AIDS Network join',
    ...
    },
    {
      year: 2011,
      description: [
        'PCHC receives a $3 million HRSA Teaching Health Center grant',
        'Pediatric Dental, Community Pharmacy, and Nurse Practitioner residency programs start',
      ],
      image: '2011.jpg',
      details: {
        text: [
    ...
    },
    {
      year: 2013,
      description: [
        'Seaport Community Health Center joins PCHC',
        'Orthodontics program begins at Dental Center',
        'Moved billing, records, and referrals departments to Services Center on Odlin Road in Bangor',
      ],
      image: '2013.jpg',
      details: {
        text: [
    ...
    },
    {
      ...
      description: [
        ...
        'Oral surgery starts at Dental Center',
        'Chiropractic Services begin in Bangor and Brewer',
      ],
      image: '2016.jpg',
      details: {
        text: [
